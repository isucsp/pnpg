    ...
    for k=1:5
        for i=1:length(m)
            ...
            for j=1:5
                ...
                npgcNew2 {i,j,k}=NPG.NPGc     (conf.Phi,conf.Phit,conf.Psi,conf.Psit,conf.y,initSig,opt);
                npgscNew2{i,j,k}=NPG.NPGsc    (conf.Phi,conf.Phit,conf.Psi,conf.Psit,conf.y,initSig,opt);
                continue;
