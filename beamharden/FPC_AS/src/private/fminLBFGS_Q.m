function [x, f, gF, Out]= fminLBFGS_Q(x, cT, AT, b, MT, opts, varargin)
...
xtol = opts.xtol; gtol = opts.gtol; Out.nfe = 0;  Out.nge = 0;

m = opts.m; istore = 0; pos = 0;  status = 0;  perm = [];
