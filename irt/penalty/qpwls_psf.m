...
%
function ctc = form_ctc_strum(R, ej, size_gtg, cgrad_delta)

try
	% todo: check cgrad_delta vs R.arg.delta?
	ctc = R.cgrad(R, cgrad_delta * ej(R.mask(:))) / cgrad_delta; % trick
...
elseif streq(class(C), 'strum') ... % new Reg1 strum
	...
	ctc = form_ctc_strum(C, ej, size_gtg, cgrad_delta);
